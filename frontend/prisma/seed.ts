...
async function main() {
    console.log('🌌 Seeding the cosmic database...');
    ...
    await prisma.project.createMany({
        data: [
            ...
            {
                title: 'Resume Blog',
                description: 'This site. A Next.js + Prisma portfolio with a drag-and-drop admin dashboard and a cosmic starfield theme.',
                repoUrl: 'https://github.com/santapong/resume-blog',
                technologies: JSON.stringify(['Next.js', 'Prisma', 'Tailwind CSS', 'Vercel']),
                featured: false,
                order: 4,
            },
            {
